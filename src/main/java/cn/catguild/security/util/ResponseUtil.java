package cn.catguild.security.util;

import cn.catguild.security.common.ApiResponse;
import cn.catguild.security.common.BaseException;
import cn.catguild.security.common.IStatus;
...
public class ResponseUtil {
     ...
     * @param data     返回数据
     */
    public static void renderJson(ServerHttpResponse response, IStatus status, Object data) {
        //try {
     ...
     * @param exception 异常
     */
    public static void renderJson(ServerHttpResponse response, BaseException exception) {
        //try {
