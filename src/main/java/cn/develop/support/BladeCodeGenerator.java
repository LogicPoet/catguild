package cn.develop.support;

import cn.develop.tool.Func;
import cn.develop.tool.StringUtil;
...
public class BladeCodeGenerator {
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "catharine-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "org.catharine.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"catharine"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"catharine_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		String author = props.getProperty("LZ");
